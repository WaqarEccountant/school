            ...
            <div class="card-body">
                ...
                <form action="{{route('teacher.exams.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input id="title" type="text" name="title" class="form-control {{ $errors->has('title') ? "is-invalid" : "" }}" value="{{ old('title') }}" placeholder="Title" autofocus required/>
                        @if($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        <input id="topic" type="text" name="topic" class="form-control {{ $errors->has('topic') ? "is-invalid" : "" }}" value="{{ old('topic') }}" placeholder="Topic" required>
                        @if($errors->has('topic'))
                    ...
                    <div class="form-group">
                        ...
                        <input id="time" type="number" name="time" class="form-control {{ $errors->has('time') ? "is-invalid" : "" }}" min="1" step="1" value="{{ old('time')??'1' }}" placeholder="Time" required>
                        @if($errors->has('time'))
                    ...
                    <div class="form-group">
                        ...
                        <input id="fee" type="number" name="fee" class="form-control {{ $errors->has('fee') ? "is-invalid" : "" }}" min="0" step="1" value="{{ old('fee')??'0' }}" placeholder="Exam Fee">
                        @if($errors->has('fee'))
