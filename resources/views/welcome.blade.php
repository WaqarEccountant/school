            ...
            <div class="container py-lg-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <div class="grids5-info">
                                <a href="#url" class="d-block zoom"><img src="{{asset("assets/images/p1.jpg")}}" loading="lazy" alt="" class="img-fluid news-image"/></a>
                                <div class="blog-info">
                ...
                <div class="list-single-view mt-3">
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <div class="grids5-info">
                                <a href="#url" class="d-block zoom"><img src="{{asset("assets/images/p2.jpg")}}" loading="lazy" alt="" class="img-fluid news-image"/></a>
                                <div class="blog-info">
                ...
                <div class="list-single-view mt-3">
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <div class="grids5-info">
                                <a href="#url" class="d-block zoom"><img src="{{asset("assets/images/p3.jpg")}}" loading="lazy" alt="" class="img-fluid news-image"/></a>
                                <div class="blog-info">
                ...
                <div class="list-single-view mt-3">
                    <div class="row">
                        <div class="col-md-12 mt-3">
                            <div class="grids5-info">
                                <a href="#url" class="d-block zoom"><img src="{{asset("assets/images/p4.jpg")}}" loading="lazy" alt="" class="img-fluid news-image"/></a>
                                <div class="blog-info">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="feature-16-gd">
                                <div class="icon">
                                    <img src="{{asset("assets/images/seminors.png")}}" loading="lazy" class="img-fluid" alt=""/>
                                </div>
                        ...
                        <div class="col-md-6 mt-md-0 mt-4">
                            <div class="feature-16-gd">
                                <div class="icon">
                                    <img src="{{asset("assets/images/course.png")}}" loading="lazy" class="img-fluid" alt=""/>
                                </div>
                                <div class="feature-16-gd-info">
                        ...
                        <div class="col-md-6 mt-4">
                            <div class="feature-16-gd">
                                <div class="icon">
                                    <img src="{{asset("assets/images/library.png")}}" loading="lazy" class="img-fluid" alt=""/>
                                </div>
                                <div class="feature-16-gd-info">
                        ...
                        <div class="col-md-6 mt-4">
                            <div class="feature-16-gd">
                                <div class="icon">
                                    <img src="{{asset("assets/images/teacher.png")}}" loading="lazy" class="img-fluid" alt=""/>
                                </div>
                                <div class="feature-16-gd-info">
                    ...
                    <div class="col-md-10 mx-auto">
                        <div class="owl-one owl-carousel owl-theme">
                            <div class="item">
                                <div class="slider-info mt-lg-4 mt-3">
                                    <div class="img-circle">
                                        <img src="{{asset("assets/images/student1.jpg")}}" loading="lazy" class="img-fluid testimonial-img" alt="client image">
                                    </div>
                                    <div class="message">
                            ...
                            <div class="item">
                                <div class="slider-info mt-lg-4 mt-3">
                                    <div class="img-circle">
                                        <img src="{{asset("assets/images/student2.jpg")}}" loading="lazy" class="img-fluid testimonial-img" alt="client image">
                                    </div>
                                    <div class="message">
                                        <span class="fa fa-quote-left" aria-hidden="true"></span>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id accusantium
                            ...
                            <div class="item">
                                <div class="slider-info mt-lg-4 mt-3">
                                    <div class="img-circle">
                                        <img src="{{asset("assets/images/student3.jpg")}}" loading="lazy" class="img-fluid testimonial-img" alt="client image">
                                    </div>
                                    <div class="message">
                                        <span class="fa fa-quote-left" aria-hidden="true"></span>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id accusantium
                            ...
                            <div class="item">
                                <div class="slider-info mt-lg-4 mt-3">
                                    <div class="img-circle">
                                        <img src="{{asset("assets/images/student4.jpg")}}" loading="lazy" class="img-fluid testimonial-img" alt="client image">
                                    </div>
                                    <div class="message">
                                        <span class="fa fa-quote-left" aria-hidden="true"></span>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id accusantium
                        ...
                        <div class="px-lg-5 py-md-0 py-3">
                            ...
                            <form action="#" method="post" class="signin-form mt-lg-5 mt-4">
                                <div class="forms-gds">
                                    ...
                                    <div class="form-input">
                                        <button class="btn btn-primary theme-button">Subscribe</button>
                                    </div>
                                </div>
                            </form>
                        </div>
